...
api = Api(app, version='alpha 0.1.13', title='MBVD-DeepLearning-DVA-MLaaS-API',description='An Swagger UI and API for tf serving and ci of new models. The models are based on user feedback.',)
