...
task_train = PythonOperator(task_id='train',provide_context=True,retries=4,python_callable=train,op_kwargs={"pipeline_config_path":pipeline_config_path, "model_dir":model_dir, "num_train_steps":num_train_steps},dag=dag)
