...
DAGS_DIR = '/tensorflow/workspace/pipeline/airflow/dags/'
METADATA_DIR = '/tensorflow/workspace/pipeline/airflow/data/'
LOGS_DIR = '/tensorflow/workspace/pipeline/airflow/logs/'
